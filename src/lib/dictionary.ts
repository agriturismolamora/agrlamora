...
export const dict = {
  ...
  newsletter: {
    ...
    accetto: { it: "Accetto i termini e le condizioni d'uso", en: "I accept the terms and conditions", fr: "J'accepte les conditions d'utilisation", de: "Ich akzeptiere die Nutzungsbedingungen" },
