...
export const dict = {
  ...
  booking: {
    ...
    whatsappAgriturismo: { it: "Scrivi su WhatsApp ad Agriturismo La Mora", en: "Message Agriturismo La Mora on WhatsApp", fr: "Écrire à Agriturismo La Mora sur WhatsApp", de: "Agriturismo La Mora auf WhatsApp schreiben" },
    whatsappVilla: { it: "Scrivi su WhatsApp per Villa Relax", en: "Message us on WhatsApp about Villa Relax", fr: "Écrire sur WhatsApp pour Villa Relax", de: "Wegen Villa Relax auf WhatsApp schreiben" },
  },
  concierge: {
