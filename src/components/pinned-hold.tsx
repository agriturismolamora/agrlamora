...
/* Effetto "trattenimento": la sezione resta agganciata in cima al viewport
   ...
   produzione su apartments-carousel.tsx e immersive-story.tsx — qui
   ...
   (>=1024px, stesso breakpoint usato dagli altri blocchi pinned): su
   mobile lo scroll resta quello normale, senza spazio extra.
